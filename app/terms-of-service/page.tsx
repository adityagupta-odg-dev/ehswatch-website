...
export async function generateMetadata(): Promise<Metadata> {
  const pageData = await getPage("terms-of-service").catch(() => null);
  const attrs = (pageData?.data as any)?.attributes ?? {};
  return {
    title: attrs.meta?.meta_title || "Terms of Service — EHSWatch",
    description:
      attrs.meta?.meta_description ||
      "The terms and conditions governing your use of the EHSWatch platform and services.",
  };
}
...
export default async function TermsOfServicePage() {
  ...
  return (
    <>
      ...
      <main>
        <LegalHero
          headline={heroBlock?.headline || "Terms of Service"}
          subheadline={heroBlock?.subheadline || "Please read these terms carefully before using EHSWatch."}
        ...
        {richTextBlocks.length > 0 ? (
          ...
          <RichTextSection
            ...
            body="<p>Our terms of service will be available soon. Please check back later.</p>"
